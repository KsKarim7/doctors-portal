...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 py-8 mx-5'>
            ...
            <InfoCard bgClass="bg-neutral" cardTitle='Our Locations' img={icon2}></InfoCard>
            <InfoCard bgClass="bg-gradient-to-r from-secondary to-primary" cardTitle='Contact Us' img={icon3}></InfoCard>
        </div>
    );
};
